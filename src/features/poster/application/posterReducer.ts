...
import { DEFAULT_BUSINESS_BRANDING } from "@/features/business/domain/types";
...
export type PosterAction =
  ...
  | { type: "SET_BUSINESS_BRANDING"; changes: Partial<BusinessBranding> };
...
export function posterReducer(
  ...
  switch (action.type) {
    ...
    case "SET_BUSINESS_BRANDING":
      return {
        ...state,
        businessBranding: { ...state.businessBranding, ...action.changes },
      };
